	 ...
	 <!-- ----- show entry ----- -->
		...
		<div data-theme="b" data-role="header" data-position="fixed" data-tap-toggle="false">
	  	...
	  	<div data-role="main" class="ui-content" data-theme="a">
				...
				<p id="show_headline_show" class="ui-btn-icon-top ui-shadow-icon ui-icon-bullets titleText"><?php echo getTXT(225); ?></p>
			      ...
			      <fieldset class="showentry-wrapper">
			     		...
			     		<input type="hidden" value="" id="show_id" name="show_id"/>
							...
							<input type="password" value="" name="show_password" id="show_password" data-inline="true" placeholder="<?php echo getTXT(106); ?>" title="<?php echo getTXT(106); ?>" tabindex="4" data-mini="true" maxlength="32"/>
							...
							<input type="password" value="" name="show_passwordconfirm" id="show_passwordconfirm"  placeholder="<?php echo getTXT(140); ?>" title="<?php echo getTXT(140); ?>" tabindex="7" data-mini="true" maxlength="32"/>
